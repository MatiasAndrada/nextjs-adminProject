...
export default async function SideNav() {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-2">
      <div className="dark:bg-slate-950 bg-blue-600 p-2 flex flex-col h-fit items-center justify-around gap-4">
      ...
      <div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
        <NavLinks />
        <div className="bg-gray-50 dark:bg-slate-950 hidden h-auto w-full grow rounded-md  md:block">
        </div>
      </div>
