          ...
          <tr>
            <td style="text-align: center; vertical-align: middle;">
              <table role="presentation" style="background-color: white; border-radius: 10px; padding: 20px; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.1); margin: 0 auto; max-width: 400px; width: 100%; border-collapse: collapse;">
                ...
                <tr>
                  <td style="text-align: center; padding-bottom: 15px;">
                    ${link ? `<a href="${link}" style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: #fff; text-decoration: none; border-radius: 5px; margin-top: 15px; font-weight: bold;">${linkText}</a>` : ""}
                  </td>
                </tr>
              </table>
            </td>
