              ...
              <table role="presentation" style="background-color: white; border-radius: 10px; padding: 20px; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.1); margin: 0 auto; max-width: 400px; width: 100%; border-collapse: collapse;">
                <tr>
                  <td style="text-align: center; padding-bottom: 15px;">
                    ...
                    <h1 style="font-size: 24px; font-weight: bold; color: #333;">Task Manager</h1>
                  </td>
                </tr>
                <tr>
                  <td style="text-align: center; padding-bottom: 15px;">
                ...
                <tr>
                  <td style="text-align: center; padding-bottom: 15px;">
                    ...
                    ${token ? `<p style="font-size: 18px; color: red;"><strong>${token}</strong></p>` : ""}
                  </td>
                </tr>
                <tr>
                  <td style="text-align: center; padding-bottom: 15px;">
                    ${link ? `<a href="${link}" style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: #fff; text-decoration: none; border-radius: 5px; margin-top: 15px;">${linkText}</a>` : ""}
                  </td>
                </tr>
              </table>
            </td>
