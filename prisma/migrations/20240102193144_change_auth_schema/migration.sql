/*
  ...
  - You are about to drop the column `author_id` on the `TaskGroup` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX "Account_id_providerId_providerAccountId_key";
...
-- AlterTable
ALTER TABLE "TaskGroup" DROP COLUMN "author_id";
