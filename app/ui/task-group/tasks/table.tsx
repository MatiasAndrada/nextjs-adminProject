                                ...
                                <table className="w-full my-0 align-middle text-dark border-neutral-200">
                                    <thead className="align-bottom">
                                        <tr className="font-semibold text-[0.95rem] text-secondary-dark">
                                            ...
                                            <th className="pb-3 text-end min-w-[100px]">TIME LEFT</th>
                                            <th className="pb-3 text-end min-w-[100px]">UPDATE AGO</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <td className="p-3 pl-0">
                                                <div className="flex items-center">
                                                    <div className="relative inline-block shrink-0 rounded-2xl me-3">
                                                        {/*      <img src="https://raw.githubusercontent.com/Loopple/loopple-public-assets/main/riva-dashboard-tailwind/img/img-49-new.jpg" className="w-[50px] h-[50px] inline-block shrink-0 rounded-2xl" alt=""> </img> */}
                                                    </div>
