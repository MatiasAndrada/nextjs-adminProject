...
import { type CurrentProjectStore, createCurrentProjectStore } from '@/store/currentProject'

export const CurrentProjectStoreContext = createContext<StoreApi<CurrentProjectStore> | null>(
  null,
)
...
export const useCurrentProjectStore = <T,>(
  ...
  if (!currentProjectStoreContext) {
    throw new Error(`useCurrentProjectStore must be use within CurrentProjectStoreProvider`)
  }
