...
export const tasks = [
  ...
  //! Task Group 3 - Tasks - Functionality Testing - clqhan80t000208lf0l5m11lm
  {
    ...
    status: Status.COMPLETED,
    progress: 100,
    description: "Conduct comprehensive testing on user authentication and login functionality. Begin by creating test cases covering various scenarios such as valid credentials, incorrect passwords, and user account lockouts. Utilize automation tools for repetitive tasks and manual testing for edge cases. Ensure thorough validation of user inputs, error handling, and session management. Document test results and provide feedback for any identified issues.",
  },
  {
    task_group_id: "clqhan80t000208lf0l5m11lm",
    ...
    status: Status.IN_PROGRESS,
    progress: 50,
    description: "Continuously assess data input validation mechanisms and error handling procedures. Develop test cases to cover a wide range of input scenarios including valid, invalid, and edge cases. Utilize both automated and manual testing techniques to verify input validation rules and error messages. Collaborate with developers to address identified issues promptly. Document test results and update validation procedures as necessary.",
  },
  {
    task_group_id: "clqhan80t000208lf0l5m11lm",
  ...
  },
  {
    ...
    status: Status.COMPLETED,
    progress: 100,
    description: "As you collaborate with the development team, prioritize addressing any issues identified during code reviews. Foster open communication and a collaborative spirit to facilitate problem-solving and knowledge sharing. Prioritize tasks based on their impact and urgency, ensuring timely resolution of identified issues. Encourage developers to seek clarification and guidance when addressing complex technical challenges. Monitor progress closely and provide support as needed to ensure successful resolution of identified issues, promoting a unified effort toward maintaining a healthy and efficient codebase.",
  },
  {
    task_group_id: "clqhanli4000308lf9r8ders1",
  ...
  },
  {
    ...
    status: Status.PENDING,
    progress: 0,
    description: "Prepare for optimizing the backend to handle increased system load and ensure optimal performance. Collaborate with backend developers to identify potential scalability bottlenecks. Implement strategies such as load balancing, caching, and database optimizations to enhance backend efficiency. Conduct stress testing to simulate increased loads and identify performance constraints. Document optimization strategies and work closely with the team to implement them effectively. Prioritize scalability and responsiveness to ensure the backend can accommodate growing user demands. Aim for a well-architected backend that seamlessly scales with increasing system usage."
  },
  {
    task_group_id: "clqhao6gx000508lf913fdeby",
  ...
  },
  {
    ...
    status: Status.PAUSED,
    progress: 0,
    description: "Conduct a thorough assessment of existing software compatibility with proposed system changes. Identify software components that may be affected by upcoming modifications. Collaborate with software developers to understand potential challenges and dependencies. Document your compatibility assessment, including identified risks and mitigations. Communicate with the team to discuss necessary adjustments and ensure a seamless integration process. Aim for compatibility between existing software and proposed changes to minimize disruptions and maintain system stability."
  },
  {
    task_group_id: "clqhaog3j000608lf5w2gfwra",
